...
if (isset($_POST['btnAdd'])) {
       ...
       if (!empty($name)) 
       {
            ...
            $sql_query = "INSERT INTO languages (name)VALUES('$name')";
            $db->sql($sql_query);
            $result = $db->getResult();
            if (!empty($result)) {
                $result = 0;
            ...
            if ($result == 1) {
                ...
                $error['add_languages'] = "<section class='content-header'>
                                                <span class='label label-success'>Languages Added Successfully</span> </section>";
            } else {
...
<section class="content-header">
    <h1>Add New languages <small><a href='languages.php'> <i class='fa fa-angle-double-left'></i>&nbsp;&nbsp;&nbsp;Back to languages</a></small></h1>

...
if (isset($_POST['btnUpdate'])) {
    ...
    if (isset($_FILES['image']['size']) && $_FILES['image']['size'] != 0 && $_FILES['image']['error'] == 0 && !empty($_FILES['image'])) {
        ...
        $sql = "UPDATE orders SET `image`='$upload_image' WHERE `id`='$ID'";
        $db->sql($sql);
        ...
        if ($update_result == 1) {
            $error['update_orders'] = " <section class='content-header'><span class='label label-success'>orders updated Successfully</span></section>";
        } else {
            $error['update_orders'] = " <span class='label label-danger'>Failed to update</span>";
        }
    }
}    
...
<h1>Edit orders <small><a href='orders.php'> <i class='fa fa-angle-double-left'></i>&nbsp;&nbsp;&nbsp;Back to orders</a></small></h1>
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="box box-primary">
                ...
                <!-- /.box-header -->
                <!-- form start -->
                <form id='edit_orders_form' method="post" enctype="multipart/form-data">
                    <div class="box-body">
                        <div class="row">

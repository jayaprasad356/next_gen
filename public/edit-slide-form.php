...
if (isset($_POST['btnUpdate'])) {
    ...
    if ($_FILES['image']['size'] != 0 && $_FILES['image']['error'] == 0 && !empty($_FILES['image'])) {
        ...
        if ($update_result == 1) {
            $error['update_slide'] = " <section class='content-header'><span class='label label-success'>slide updated Successfully</span></section>";
        } else {
...
<section class="content-header">
    <h1>Edit Slide <small><a href='slide.php'> <i class='fa fa-angle-double-left'></i>&nbsp;&nbsp;&nbsp;Back to Slide</a></small></h1>
